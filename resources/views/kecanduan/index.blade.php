            ...
            <div class="col-sm-12 my-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('check.kecanduan') }}" method="post" id="cek-kecanduan">
                            @csrf
                    ...
                    <div class="card-footer">
                        <button class="btn btn-primary" form="cek-kecanduan">Cek Sekarang</button>
